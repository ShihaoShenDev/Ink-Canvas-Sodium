...
namespace Ink_Canvas {
    public partial class MainWindow : PerformanceTransparentWin {
        // P/Invoke for GetActiveObject in .NET 10
        ...
        private static object GetActiveObjectCompat(string progId) {
            try {
        ...
        private void BtnCheckPPT_Click(object sender, RoutedEventArgs e) {
            try {
                pptApplication =
                    (Microsoft.Office.Interop.PowerPoint.Application)GetActiveObjectCompat("kwpp.Application");
        ...
        private void TimerCheckPPT_Elapsed(object sender, ElapsedEventArgs e) {
            ...
            try {
                ...
                pptApplication =
                    (Microsoft.Office.Interop.PowerPoint.Application)GetActiveObjectCompat("PowerPoint.Application");
