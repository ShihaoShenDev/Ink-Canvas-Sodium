    ...
    public partial class PerformanceTransparentWin : Window
    {
        ...
        public PerformanceTransparentWin()
        {
            ...
            else
            {
                ...
                Background = BrushCreator.GetOrCreate("#01000000");
                _hwnd = new WindowInteropHelper(this).EnsureHandle();
            }
        }
        ...
        public void SetTransparentHitThrough()
        {
            if (_dwmEnabled)
            {
                ...
                Win32.User32.SetWindowPos(_hwnd, IntPtr.Zero, 0, 0, 0, 0, Win32.SetWindowPosFlags.SWP_NOMOVE | Win32.SetWindowPosFlags.SWP_NOSIZE | Win32.SetWindowPosFlags.SWP_NOZORDER | Win32.SetWindowPosFlags.SWP_FRAMECHANGED);
            }
            else
            {
                Background = Brushes.Transparent;
